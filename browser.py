...
class BrowserWindow(QMainWindow):
    ...
    def _build_toolbar(self) -> None:
        ...
        next_action.triggered.connect(self.go_forward)
    ...
    def _build_shortcuts(self) -> None:
        ...
        QShortcut(QKeySequence("Ctrl+R"), self, activated=self.reload_current_tab)
    ...
    def add_bookmark(self) -> None:
        ...
        self.storage.add_bookmark(
            current.title() or current.url().toString(),
